...
class HairTriangleBoxBbraids extends StatefulWidget {

  @override
  _HairTriangleBoxBbraidsnState createState() => new _HairTriangleBoxBbraidsnState();
}

class _HairTriangleBoxBbraidsnState extends State<HairTriangleBoxBbraids> {
