...
class HairKnotlessBraids extends StatefulWidget {

  @override
  _HairKnotlessBraidsState createState() => new _HairKnotlessBraidsState();
}

class _HairKnotlessBraidsState extends State<HairKnotlessBraids> {
  ...
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection("hairKnotlessBraids");
