...
class HairLemonadebraids extends StatefulWidget {

  @override
  _HairLemonadebraidsState createState() => new _HairLemonadebraidsState();
}

class _HairLemonadebraidsState extends State<HairLemonadebraids> {
  ...
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection("hairLemonadebraids");
