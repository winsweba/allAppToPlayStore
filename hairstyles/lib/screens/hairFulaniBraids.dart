...
class HairFulaniBraids extends StatefulWidget {

  @override
  _HairFulaniBraidsState createState() => new _HairFulaniBraidsState();
}

class _HairFulaniBraidsState extends State<HairFulaniBraids> {
  ...
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection("hairFulaniBraids");
