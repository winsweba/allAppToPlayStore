...
class HairPassionTwists extends StatefulWidget {

  @override
  _HairPassionTwistsState createState() => new _HairPassionTwistsState();
}

class _HairPassionTwistsState extends State<HairPassionTwists> {
  ...
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection("hairPassionTwists");
